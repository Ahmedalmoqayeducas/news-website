<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url('news/img/1.jpg')">
            ...
            <div class="carousel-item" style="background-image: url('news/img/22.jpg')">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item" style="background-image: url('news/img/1.jpg')">
                <div class="carousel-caption d-none d-md-block">
